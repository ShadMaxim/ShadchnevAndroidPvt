...
class Dz12Activity : FragmentActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener, GoogleMap.OnMapClickListener {
    ...
    private lateinit var observerState: Observer<Dz12State>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this).get(Dz12ViewModel::class.java)

        bottomSheetBehavior = BottomSheetBehavior.from(findViewById(R.id.dz9container))
        bottomSheetBehavior.state = BottomSheetBehavior.STATE_COLLAPSED

        if (savedInstanceState == null) {
            replaceFragment(R.id.dz9container, Dz12Fragment())
        }
    ...
    fun onSuccessfully(list: List<Poi>) {
        listPoi.addAll(list)
